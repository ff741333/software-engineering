...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="page/main.html"><i class="layui-icon" data-icon=""></i><cite>系统首页</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);
...
//				var index1 = _this.parent().parent('.layui-nav-item').index();
	      //         alert($(".layui-tab-title.top_tab li").length);
			//	alert($(this).find("lay-id").index())
	//			alert($(this).parent("li").index());
	//			for(var i=1;i<$(".layui-tab-title.top_tab li").length;i++)
	//		that.changeRegresh(i);
